...
<body>
	...
	<div id="konten">
		...
		<h3 style="color:#999">edit Berita </h3>
		<?php
		...
		while ($r = mysqli_fetch_array($data)) {
			...
			<form method="post" action="aksi.php?mod=editdata" enctype="multipart/form-data">
				...
				<input type="text" name="judul" value="<?php echo $r['judul']; ?>" placeholder="Judul Berita">
				<textarea name="berita" placeholder="Isi Berita"><?php echo $r['isi_berita']; ?></textarea>
